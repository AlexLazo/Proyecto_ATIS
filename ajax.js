...
$('#addRoom').submit(function() {
    ...
    $.ajax({
        ...
        dataType: 'JSON',
        data: {
            id_tipohabitacion: room_type_id,
            numeroHabitacion: room_no,
            add_room: ''
        },
...
function validId(val) {
    if (val == 1) {
        ...
        document.getElementById('id_card_no').setAttribute('data-minlength', '9');
        document.getElementById('id_card_no').setAttribute('placeholder', "0000000-0");
        document.getElementById('id_card_no').setAttribute('data-error', "Ingresa tu número de DUI de 8 dígitos (incluya -)");
    } else if (val == 2) {
        document.getElementById('id_card_no').setAttribute('type', 'text');
        document.getElementById('id_card_no').setAttribute('data-minlength', '17');
        document.getElementById('id_card_no').setAttribute('placeholder', "0614-111102-111-0");
        document.getElementById('id_card_no').setAttribute('data-error', "Ingresa tú número de NIT");
    } else if (val == 3) {
        document.getElementById('id_card_no').setAttribute('type', 'text');
        document.getElementById('id_card_no').setAttribute('data-minlength', '9');
        document.getElementById('id_card_no').setAttribute('placeholder', "AO1234567");
        document.getElementById('id_card_no').setAttribute('data-error', "Ingresa un Pasaporte de 9 dígitos válidos");
    } else if (val == 4) {
        document.getElementById('id_card_no').setAttribute('type', 'text');
        document.getElementById('id_card_no').setAttribute('data-minlength', '17');
...
$('#booking').submit(function() {
    ...
    if (!room_no && !first_name && !contact_no && !id_card_no && !address) {
        $('.response').html('<div class="alert bg-danger alert-dismissable" role="alert"><em class="fa fa-lg fa-warning">&nbsp;</em>Por favor llena la información</div>');
    } else {
        $.ajax({
            type: 'post',
            url: 'ajax.php',
            ...
            success: function(response) {
                if (response.done == true) {
                    ...
                    $('#getPaymentStaus').html("Sin pagar");
